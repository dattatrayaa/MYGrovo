...
class AssignCampTwoLessonsTwoTracksGraded:
    
    def campaignToAssignWithTwoTrackLessons(self,campaignTitle,campDescription,lessonName1,lessonName2,trackName1,trackName2,nameOFuser,minPassingScore,numberOfAttempts):
        ...
        elements.searchTracksAndSelect(trackName1)
        elements.searchTracksAndSelect(trackName2)
        ...
        if trackName1 in elements.firstTrackInGrid():
    ...
    def assignCampWithTwoTrackTwoLessonGraded(self):
        ...
        cell2 = first_sheet.cell(84,1)
        textCard= cell2.value
        
        
        cell2 = first_sheet.cell(85,1)
        questionCard= cell2.value
        
        cell2 = first_sheet.cell(86,1)
        ans1= cell2.value
        
        cell2 = first_sheet.cell(87,1)
        ans2= cell2.value
        ...
        trackName1= cell2.value
        
        cell2 = first_sheet.cell(90,1)
        trackName2= cell2.value
        ...
        cell2 = first_sheet.cell(93,1)
        tagName= cell2.value
        
        cell2 = first_sheet.cell(94,1)
        expectedSuccessText1= cell2.value
        
        cell2 = first_sheet.cell(95,1)
        expectedSuccessText2= cell2.value
        ...
        cell = first_sheet.cell(101,1)
        Password = cell.value
        
        cell = first_sheet.cell(102,1)
        NewPassword = cell.value
        
        cell = first_sheet.cell(103,1)
        role = cell.value
        ...
        sheet.cell(row=98, column=2).value = FirstNameUpdated
        sheet.cell(row=99, column=2).value = LastNameUpdated
        sheet.cell(row=100, column=2).value = EmailIdUpdated
        sheet.cell(row=101, column=2).value = EmployeeIdUpdated
        ...
        try:
            ...
            print "\nCreating Track\n"
            tr=CreateTrackComman()
            tr.createTrack(trackName1, Imagefilepath, description, tagName, lessonName1, expectedSuccessText1)
            tr.createTrack(trackName2, Imagefilepath, description, tagName, lessonName2, expectedSuccessText2)
            
            print "\nCreating Campaign\n"
            jk=AssignCampTwoLessonsTwoTracksGraded()
            jk.campaignToAssignWithTwoTrackLessons(campaignTitle, campDescription, lessonName1, lessonName2, trackName1, trackName2, nameOFuser, minPassingScore, numberOfAttempts)
