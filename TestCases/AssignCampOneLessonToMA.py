...
class AssignCampOneLessonToMA:
    
    def campaignTolearnerOneLessonToMA(self,campaignTitle,campDescription,lessonName,nameOFuser,minPassingScore,numberOfAttempts):
    ...
    def assignCampOneForLessonToMA(self):
        ...
        cell2 = first_sheet.cell(192,1)
        questionCard= cell2.value
        
        cell2 = first_sheet.cell(193,1)
        ans1= cell2.value
        
        cell2 = first_sheet.cell(194,1)
        ans2= cell2.value
        
        cell2 = first_sheet.cell(203,1)
        minPassingScore= cell2.value
        
        cell2 = first_sheet.cell(204,1)
        ...
        sheet.cell(row=197, column=2).value = FirstNameUpdated
        sheet.cell(row=198, column=2).value = LastNameUpdated
        sheet.cell(row=199, column=2).value = EmailIdUpdated
        sheet.cell(row=200, column=2).value = EmployeeIdUpdated
        ...
        try:
            ...
            print "\nCreating Campaign\n"
            lk=AssignCampOneLessonToMA()
            lk.campaignTolearnerOneLessonToMA(campaignTitle, campDescription, lessonName, nameOFuser, minPassingScore, numberOfAttempts)
