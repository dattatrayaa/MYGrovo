...
class AssignCampOneLessonToLA:
    def campaignTolearnerOneLessonToLA(self,campaignTitle,campDescription,lessonName,nameOFuser):
    ...
    def assignCampOneForLessonToLA(self):
        ...
        cell = first_sheet.cell(182,1)
        Password = cell.value
        
        cell = first_sheet.cell(183,1)
        NewPassword = cell.value
        
        cell = first_sheet.cell(184,1)
        role = cell.value
        ...
        sheet.cell(row=179, column=2).value = FirstNameUpdated
        sheet.cell(row=180, column=2).value = LastNameUpdated
        sheet.cell(row=181, column=2).value = EmailIdUpdated
        sheet.cell(row=182, column=2).value = EmployeeIdUpdated
        ...
        try:
            ...
            print "\nCreating Campaign\n"
            lk=AssignCampOneLessonToLA()
            lk.campaignTolearnerOneLessonToLA(campaignTitle, campDescription, lessonName, nameOFuser)
