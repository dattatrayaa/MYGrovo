...
Library           TestCases/AssignCampAllCardsLessonToLearner.py
Library           TestCases/AssignCampLessonToGroupTriggered.py
Library           TestCases/AssignCampNewHireTriggeredOneTrackAndOneLesson.py
Library           TestCases/AssignCampOneLessonToCreator.py
Library           TestCases/AssignCampOneLessonToLA.py
Library           TestCases/AssignCampOneLessonToMA.py
Library           TestCases/AssignCampOneLessonTrackToLearner.py
Library           TestCases/AssignCampOneTrackContainsFourLessons.py
Library           TestCases/AssignCampTenLessonsWithGraded.py
Library           TestCases/AssignCampTwoLessonsTwoTracksGraded.py
